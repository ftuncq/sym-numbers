 ...
 */
final class Version20250617085557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE program_translation (id INT AUTO_INCREMENT NOT NULL, object_id INT NOT NULL, locale VARCHAR(8) NOT NULL, field VARCHAR(32) NOT NULL, content LONGTEXT DEFAULT NULL, INDEX IDX_78730807232D562B (object_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE program_translation ADD CONSTRAINT FK_78730807232D562B FOREIGN KEY (object_id) REFERENCES program (id) ON DELETE CASCADE');
    }
